...
func (n *node) addRoute(path string, handle CustomHandle) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(numParams uint8, path, fullPath string, handle CustomHandle) {
...
// given path.
func (n *node) getValue(path string) (handle CustomHandle, p Params, tsr bool) {
